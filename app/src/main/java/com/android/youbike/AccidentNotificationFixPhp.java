...
public class AccidentNotificationFixPhp {
    private static HttpClient HC;
    private static HttpPost HP;

    public static String AccidentNotificationFixPhp (String i, String Wcook, String url){
        String result="錯誤";
        try {

            HC =new DefaultHttpClient();
            HP=new HttpPost(url+"repairInfo.php");
